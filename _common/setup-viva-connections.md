...
![Create and manage Viva Connections experiences](media/vc-manage-experiences.png)
...
![Build from an existing portal](media/vc-build-from-existing-portal.png)
...
![Add URL for the new site](media/vc-add-url-home-site.png)

### Review and finish

There's not much to see here, so click **Create experience**.

![Review and finish](media/vc-review-and-finish.png)

### Confirmation

Even less to see here, so click **Close**.

![Confirmation](media/vc-confirmation.png)
